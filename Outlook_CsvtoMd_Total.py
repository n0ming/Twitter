...
sub_link = False
Index = 'X'
with open("data_8_23.csv", mode='w', encoding='utf-8-sig', newline='') as file:
...
def save_csv(browser_url,browser):
    ...
    while True:
        ...
        with open("data_8_23.csv", mode='a', encoding='utf-8-sig', newline='') as file:
            writer = csv.writer(file)
...
if __name__ == "__main__":
    ...
    try:
       print("두번째 py 실행 중")
       subprocess.run(['python', 'docs_Test.py'])  # '두번째파일.py'는 두 번째 스크립트 파일의 이름입니다.
